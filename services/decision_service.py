...
def get_user_decisions(
    ...
    for row in res.data:
        ...
        current_calc = CalculateResponse(
            ...
            actual_date_used=decision.actual_date_used or decision.decision_date,
            ...
            current_date=decision.current_date_snapshot or decision.actual_date_used or decision.decision_date,
